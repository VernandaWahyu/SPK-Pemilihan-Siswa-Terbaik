...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="mdi mdi-account"></i> Data User</h1>

    <a href="<?= base_url('User/create'); ?>" class="btn btn-primary"> <i class="mdi mdi-plus"></i> Tambah Data </a>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="mdi mdi-table"></i> Daftar Data User</h6>
    </div>
