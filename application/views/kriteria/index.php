...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?= base_url('Kriteria/create'); ?>" class="btn btn-primary"> <i class="mdi mdi-plus"></i> Tambah Data </a>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="mdi mdi-table-large"></i> Daftar Data Kriteria</h6>
    </div>
