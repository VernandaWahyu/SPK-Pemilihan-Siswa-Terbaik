...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="mdi mdi-table"></i> Data Sub Kriteria</h1>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="mdi mdi-table-large"></i> Daftar Data Sub Kriteria</h6>
    </div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			...
			<a href="#tambah<?= $key->id_kriteria ?>" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="mdi mdi-plus"></i> Tambah Data </a>
		</div>
    </div>
	...
	<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="myModalLabel"><i class="mdi mdi-plus"></i> Tambah <?= $key->keterangan ?></h5>
